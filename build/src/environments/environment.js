...
class Environment {
    constructor(NODE_ENV) {
        const env = NODE_ENV || process.env.NODE_ENV || environment_constant_1.Environments.DEV;
    ...
    getCurrentEnvironment() {
        let environment = process.env.NODE_ENV || environment_constant_1.Environments.DEV;
        if (!environment) {
            environment = environment_constant_1.Environments.LOCAL;
        }
        switch (environment) {
            case environment_constant_1.Environments.PRODUCTION:
                return environment_constant_1.Environments.PRODUCTION;
            case environment_constant_1.Environments.DEV:
            case environment_constant_1.Environments.TEST:
            case environment_constant_1.Environments.QA:
                return environment_constant_1.Environments.TEST;
            case environment_constant_1.Environments.STAGING:
                return environment_constant_1.Environments.STAGING;
            case environment_constant_1.Environments.LOCAL:
            default:
                return environment_constant_1.Environments.LOCAL;
        }
    }
    setEnvironment(env) {
        let envPath;
    ...
    isDevEnvironment() {
        return this.getCurrentEnvironment() === environment_constant_1.Environments.DEV || this.getCurrentEnvironment() === environment_constant_1.Environments.LOCAL;
    }
    isTestEnvironment() {
